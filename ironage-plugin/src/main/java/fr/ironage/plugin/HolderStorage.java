...
public final class HolderStorage {
    ...
    /** Vide entierement les deux fichiers (utilise par /ironage reset). */
    public void clearAll() {
        for (String key : new ArrayList<>(originalConfig.getKeys(false))) {
            originalConfig.set(key, null);
        }
        for (String key : new ArrayList<>(currentConfig.getKeys(false))) {
