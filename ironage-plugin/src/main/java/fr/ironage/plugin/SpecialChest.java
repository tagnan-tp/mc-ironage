 ...
 * qu'il se retrouve automatiquement sur le bloc une fois le coffre pose.
 */
public final class SpecialChest {
    ...
    public ItemStack createItem() {
        ...
        item.editMeta(meta -> {
            ...
            if (meta instanceof BlockStateMeta blockStateMeta) {
                ...
                blockState.getPersistentDataContainer().set(key, PersistentDataType.BYTE, (byte) 1);
    ...
    public boolean isSpecialChestBlock(BlockState state) {
        ...
        return state.getPersistentDataContainer().has(key, PersistentDataType.BYTE);
    }
}
