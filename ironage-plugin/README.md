...
- **Failles de contournement fermées** :
  ...
  - **Wagon-coffre, cheval/âne/mule/lama** : même blocage de stockage que les
    coffres classiques.
...
monde. Activable/désactivable avec `/coifeur` (réservé aux joueurs OP et à la
console). Réglable dans `config.yml` :
